...
function portfolioPage() {
  const projects = [
    ...
    { title: 'AI 数据研发 Copilot', summary: '平台内置 AI 助手「Etl-Jarvis」：需求澄清、证据采集、SQL 生成、检核与文档同步，支持一键导出数据线详细设计报告；MAIN 调度器按路由判定直达或走八步长链路。', tags: ['NL2SQL', 'AI 助手', 'Agent'], imgs: ['../assets/portfolio/ai-assistant.png', '../assets/portfolio/main-flow.png', '../assets/portfolio/ai-export.jpg'], action: '<span class="portfolio-link muted">已投产 · 界面演示</span>' },
